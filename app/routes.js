...
app.get('/editBanner', function(req, res) {
  ...
  app.get('/SeanTTSTOCKstatus', function (req, res , done) {
   // console.log(res);
    ...
    // var tokenstatus = req.query.tokenval;        
     var fs = require("fs");
       let rawdata = fs.readFileSync('public/json/seanTTSTOCK.json');
       let userdetail = JSON.parse(rawdata);
        // let userdetailNew = JSON.parse(userdetail);
        // console.log(userdetail);  
        // console.log(userdetail.status);
        ...
        fs.writeFile('public/json/seanTTSTOCK.json', data, (err) => {
             if (err) throw err;
             console.log(data);
        });            
  ...
  app.get('/BushwickTTSTOCKstatus', function (req, res , done) {
   // console.log(res);
    ...
    // var tokenstatus = req.query.tokenval;        
     var fs = require("fs");
       let rawdata = fs.readFileSync('public/json/bushwikTTSTOCK.json');
       let userdetail = JSON.parse(rawdata);
        // let userdetailNew = JSON.parse(userdetail);
        // console.log(userdetail);  
        // console.log(userdetail.status);
        ...
        fs.writeFile('public/json/bushwikTTSTOCK.json', data, (err) => {
             if (err) throw err;
             console.log(data);
        });            
   ...
   // console.log(res);
    ...
    // var tokenstatus = req.query.tokenval;        
     ...
     app.get('/seanBlack_List_SMStatus', function (req, res , done) {
   // console.log(res);
    ...
    // var tokenstatus = req.query.tokenval;        
     var fs = require("fs");
       let rawdata = fs.readFileSync('public/json/seanBlackListSM.json');
       let userdetail = JSON.parse(rawdata);
        // let userdetailNew = JSON.parse(userdetail);
        // console.log(userdetail);  
        // console.log(userdetail.status);
        ...
        fs.writeFile('public/json/seanBlackListSM.json', data, (err) => {
             if (err) throw err;
             console.log(data);
        });            
     ...
     app.get('/bushwickBlack_List_SMStatus', function (req, res , done) {
   // console.log(res);
    ...
    // var tokenstatus = req.query.tokenval;        
     var fs = require("fs");
       let rawdata = fs.readFileSync('public/json/bushwickBlackListSM.json');
       let userdetail = JSON.parse(rawdata);
        // let userdetailNew = JSON.parse(userdetail);
        // console.log(userdetail);  
        // console.log(userdetail.status);
        ...
        fs.writeFile('public/json/bushwickBlackListSM.json', data, (err) => {
             if (err) throw err;
             console.log(data);
        });            
...
console.log(_id);
 ...
 Consult.find({'doctor_read_status': '0'},function (err, totalconsult) {
  ...
  //  console.log(_id);
    ...
    var multer = require('multer');
    var upload = multer({ dest: 'public/csv'});
    app.post('/TTSTOCK-upload', function(req, res) {
    ...
    var multer = require('multer');
    var upload = multer({ dest: 'public/csv'});
    app.post('/blacklist_SM-upload', function(req, res) {
